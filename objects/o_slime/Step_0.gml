switch(state)
{
	case "Chase":
		#region Chease State
		set_state_sprite(Slime_Walk, 0.4 , 0)
	...
	case "Attack":
		#region Attack State
		set_state_sprite(Slime_Attack, 0.4, 0)
		
		if animation_hit_frame(3)
		{
		audio_play_sound(sound_sword_two, 1000, false)
		create_hitbox(x, y, self, Slime_Attack_damage, 4, 4, 2, image_xscale)
		}
	...
	case "Knockback":
		...
		knockback_state(Slime_Hit, "Chase")
